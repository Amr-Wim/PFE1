...
public class Hospitalisation {
    ...
    public Hospitalisation(int id, int idPatient, String nomHopital, String service, String duree, String etat,
                           ...
                           String diagnosticInitial, Date dateSortiePrevue, Date dateSortieReelle) {
        this.id = id;
    ...
    public Date getDateSortieReelle() { return dateSortieReelle; }
    public void setDateSortieReelle(Date dateSortieReelle) { this.dateSortieReelle = dateSortieReelle; }
